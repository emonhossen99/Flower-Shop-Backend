                                ...
                                <tr>
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;"
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                    style="font-size: 16px; line-height: 25.6px; color: #000000;">{{ env('APP_PHONE') ?? '' }}</span></p>
                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                    style="font-size: 16px; line-height: 25.6px;">{{ env('APP_EMAIL') ?? '' }}</span>
                                            </p>
                                        </div>
                                                        ...
                                                        <tr style="vertical-align: top">
                                                            <td align="left" valign="middle"
                                                                ...
                                                                <a href="https://www.facebook.com/"
                                                                    title="Facebook"
                                                                    target="_blank">
                                                                    <img src="{{ asset('backend/assets/email-template-image/facebook.png') }}"
                                                                        alt="Facebook"
                                                        ...
                                                        <tr style="vertical-align: top">
                                                            <td align="left" valign="middle"
                                                                ...
                                                                <a href="https://www.linkedin.com/"
                                                                    title="LinkedIn"
                                                                    target="_blank">
                                                                    <img src="{{ asset('backend/assets/email-template-image/linkedin.png') }}"
                                                                        alt="LinkedIn"
                                                        ...
                                                        <tr style="vertical-align: top">
                                                            <td align="left" valign="middle"
                                                                ...
                                                                <a href="https://www.instagram.com/"
                                                                    title="Instagram"
                                                                    target="_blank">
                                                                    <img src="{{ asset('backend/assets/email-template-image/instagram.png') }}"
                                                                        alt="Instagram"
                                                        ...
                                                        <tr style="vertical-align: top">
                                                            <td align="left" valign="middle"
                                                                ...
                                                                <a href="https://twitter.com/"
                                                                    ...
                                                                    <img src="{{ asset('backend/assets/email-template-image/twitter .png') }}"
                                                                        alt="Twitter"
                                    ...
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 14px; line-height: 180%;"><span
                                                    ...
                                                    © {{ env('APP_NAME') }}  All Rights Reserved.</span></p>
                                        </div>
