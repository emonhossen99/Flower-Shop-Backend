    ...
    <section>
        <div class="card">
            <div class="card-heading">
                <h3 class="p-2">{{ __f('Testimonail Create Title') }}</h3>
            </div>

            <div class="card-body">
                <form id="testimonailCreateForm" action="{{ route('admin.testimonail.store') }}" method="POST"
                    ...
                    <div class="row g-4 mb-2">
                        ...
                        <x-form.textbox labelName="{{ __f('User Designation Label Title') }}" parantClass="col-12 col-md-6"
                            ...
                            errorName="designation" class="py-2" value="{{ old('designation') }}" type="text"></x-form.textbox>
                    </div>
                    <div class="row g-4 mb-2">
                        <x-form.textbox labelName="{{ __f('User Ratting Label Title') }}" parantClass="col-12 col-md-6"
                            ...
                            errorName="ratting" class="py-2" value="{{ old('ratting') }}" type="number" min="1" max="5"></x-form.textbox>
                    ...
                    <div class="row g-4 mb-2">
                        <x-form.textarea labelName="{{ __f('User Review Label Title') }}" class="summernote"
                            ...
                            errorName="review" value="{{ old('review') }}"></x-form.textarea>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#testimonailCreateForm').on('submit', function(e) {
                e.preventDefault();
