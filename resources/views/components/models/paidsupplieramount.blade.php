<!-- Modal -->
  <div class="modal fade" id="PaidSupplierAmountModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="PaidSupplierAmountModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="PaidSupplierAmountModalLabel">{{ __f("Paid Amount Modal Title") }}</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form id="paidsupplieramountsubmit" action="{{ route('admin.supplier.due.amount.payment') }}" method="POST" enctype="multipart/form-data">
            @csrf
