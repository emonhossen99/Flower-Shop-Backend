        ...
        <div class="row g-5 justify-content-center align-items-center">
            <div class="col-md-7 mb-3 mt-3">
                <div class="login-card-three">
                    <img src="{{ asset(config('settings.login_page_three_right_image') ?? 'backend/assets/loginpage/defaultrightimage.jpg') }}"
                        alt="image">
                </div>
            </div>
                ...
                <div class="login-card-three">
                    <div class="card-body-three">
                        <div class="heading mb-1">
                            <h2 class="text-center">{{ config('settings.registerpagefirsttitle') ?? '' }}</h2>
                        </div>
                        <div>
                            <form method="POST" action="{{ route('user.register.store') }}">
                                ...
                                <div class="row mb-2">
                                    <div class="input-group">
                                        <span class="input-group-text" id="user-fname"><i
                                                class="fa-solid fa-user"></i></span>
                                        <input type="text" name="fname" class="form-control"
                                            placeholder="Enter Your First Name" aria-label="user-fname"
                                ...
                                <div class="row mb-2">
                                    <div class="input-group">
                                        <span class="input-group-text" id="user-lname"><i
                                                class="fa-solid fa-user-plus"></i></span>
                                        <input type="text" name="lname" class="form-control"
                                            placeholder="Enter Your Last Name" aria-label="user-lname"
                                            aria-describedby="user-email">
                                    </div>
                                    @error('lname')
                                        <p class="text-danger">{{ $message }}</p>
                                ...
                                <div class="row mb-2">
                                    <div class="input-group">
                                        <span class="input-group-text" id="user-phone"><i
                                ...
                                <div class="row mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="password" name="password_confirmation" class="form-control"
                                            ...
                                            aria-label="user-password_confirmation"
